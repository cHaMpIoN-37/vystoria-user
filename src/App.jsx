        ...
        <div className="w-full h-[56.25vw] max-h-screen sm:aspect-video sm:h-full sm:w-auto relative overflow-hidden bg-[#0B0B14] text-white shadow-2xl flex flex-col justify-center">
          ...
          {playerState === 'main_menu' && (
            <div className="relative z-10 w-full h-full">
               <h1 className="absolute top-[38%] left-[max(2rem,env(safe-area-inset-left))] right-[max(2rem,env(safe-area-inset-right))] text-[clamp(40px,17vw,70px)] md:text-4xl leading-[1.05] font-markazi font-bold text-white drop-shadow-xl">{selectedGame?.title || 'Visual Novel'}</h1>
          ...
          {playerState === 'paused' && (
            <div className="relative z-10 flex flex-col items-center justify-center w-full h-full overflow-y-auto px-6 py-[max(1.5rem,env(safe-area-inset-top))] bg-black/30 backdrop-blur-[2px]">
               <h1 className="text-[clamp(22px,7.7vw,30px)] md:text-4xl font-serif font-bold text-white mb-8 drop-shadow-xl text-center px-4 break-words">{selectedGame?.title || 'Visual Novel'}</h1>
